...
export class BuyerCOAgreementComponent extends BaseCounterOfferAbstract<null> implements OnInit {
  ...
  ngOnInit() {
    ...
    this.documentForm = this.fb.group({
      date_buyer_counter_date: [{value: null, disabled: this.isDisabled}, []],
      radio_counter_offer_type: [{value: 'Counter Offer', disabled: this.isDisabled}, []],
      text_offer_type_other: [{value: null, disabled: this.isDisabled}, []],
      text_counter_offer_number: [{value: null, disabled: this.isDisabled}, []],
      text_multiple_counter_offer_number: [{value: null, disabled: this.isDisabled}, []],
      ...
      check_buyer_withdraw: [{value: null, disabled: this.isDisabled}, []],
      ...
      text_buyer_name_second: [{value: this.getSignFieldAllowedFor('buyers', 0), disabled: this.isDisabled}, []],
      ...
      text_seller_signature_name_first: [{value: this.getSignFieldAllowedFor('buyers', 1), disabled: this.isDisabled}, []],
      date_seller_first_signature: [{value: this.getSignFieldAllowedFor('seller', 0), disabled: this.isDisabled}, []],
      time_seller_signature_time_first: [{value: this.getSignFieldAllowedFor('seller', 0), disabled: this.isDisabled}, []],
      ...
      date_seller_second_signature: [{value: this.getSignFieldAllowedFor('seller', 1), disabled: this.isDisabled}, []],
      time_seller_signature_time_second: [{value: this.getSignFieldAllowedFor('seller', 1), disabled: this.isDisabled}, []],
